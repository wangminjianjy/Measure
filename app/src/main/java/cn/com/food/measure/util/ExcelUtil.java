...
public class ExcelUtil {
    ...
    public static void initExcel(String fileName, String[] colName) {
        ...
        try {
            ...
            WritableSheet sheet = workbook.createSheet(fileName.replace(BaseConfig.FILE_NAME, ""), 0);
    ...
    public static List<BusinessBean> read2DB(File f, Context con) {
        ArrayList<BusinessBean> billList = new ArrayList<BusinessBean>();
        try {
...
//				BusinessBean tc = new BusinessBean();
